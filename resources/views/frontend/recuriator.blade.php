                    ...
                    <div class="mb-4 mb-xl-0 text-center text-md-start">
                        ...
                        <div class="mb-6 mb-0">
                            <ul class="list-unstyled fs-4 ">
                                <li class="mb-2 text-white-50"><span class="me-2 "><i class="fe fe-clock text-warning "></i></span><span
                                        class="align-top">4 Hours</span></li>
                                <li class="mb-2 text-white-50"><span class="me-2 "><i class="fe fe-video text-warning "></i></span><span
                                        class="align-top">12 Videos</span></li>
                                <li class="mb-2 text-white-50"><span class="me-2 "><i class="fe fe-users text-warning "></i></span><span
...
<!--
                            ...
                            <form>
                                ...
                                <!-- phone number -->
                                <div class="mb-3">
                                    <label for="number" class="form-label visually-hidden">Email</label>
                                    <input type="number" id="number" class="form-control" name="phone number" placeholder="Email"
                                           required="">
                                </div>
                                <!-- company -->
                                <div class="mb-3">
                                    <label for="company" class="form-label visually-hidden">Company</label>
                                    <input type="text" id="company" class="form-control" name="phone number" placeholder="Company"
                                           required="">
                                </div>
                                <!-- company -->
                                <div class="mb-3">
                                    <label for="position" class="form-label visually-hidden">Position</label>
                                    <select class="form-control" id="position">
                                        <option selected disabled>Select Your Position On Your Company</option>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    <!-- Feature -->
                    <div class="text-dark fw-semi-bold lh-1 fs-4 mb-3 mb-lg-0"><span
                            class="icon-shape icon-xs rounded-circle bg-light-warning text-center me-2"><i
              ...
              Deadlines</span></div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <!-- Feature -->
                    <div class="text-dark fw-semi-bold lh-1 fs-4 mb-3 mb-md-0"><span
                            class="icon-shape icon-xs rounded-circle bg-light-warning text-center me-2"><i
              ...
              Online Courses</span></div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <!-- Feature -->
                    <div class="text-dark fw-semi-bold lh-1 fs-4"><span
                            class="icon-shape icon-xs rounded-circle bg-light-warning text-center me-2"><i
                ...
                <div class="col-md-10">
                    <div class="row align-items-center ">
                        ...
                        <div class="offset-xl-1 col-xl-5 col-lg-5 col-12 mb-6 mb-lg-0 order-lg-2 text-center ">
                            <img src="{{ asset("frontend") }}/assets/images/instructor/instructor-img.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-12 mb-4 mb-lg-0">
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-footer bg-primary text-center border-top-0">
                            <div class="mt-n8"><img src="{{ asset("frontend") }}/assets/images/avatar/avatar-1.jpg" alt=""
                ...
                <div class="col-md-6 col-12">
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-footer bg-info text-center border-top-0">
                            <div class="mt-n8"><img src="{{ asset("frontend") }}/assets/images/avatar/avatar-2.jpg" alt=""
                  ...
                  <span class="me-auto">
                    ...
                    <i class="fe fe-plus text-primary"></i>
                        ...
                        <div class="border-bottom py-3" id="headingTwo">
                            <h3 class="mb-0 fw-bold">
                                <a href="#" class="d-flex align-items-center text-inherit text-decoration-none" data-bs-toggle="collapse"
