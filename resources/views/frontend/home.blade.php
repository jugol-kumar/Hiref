                            ...
                            <div>
                                <div class="d-md-flex">
                                    <div class="mb-3 mb-md-0">
                                        <!-- Img -->
                                        <img src="{{ asset("frontend") }}/assets/images/job/job-brand-logo/job-list-logo-1.svg"
                            ...
                            <div>
                                <div class="d-md-flex">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <img src="{{ asset("frontend") }}/assets/images/job/job-brand-logo/job-list-logo-2.svg"
                                             alt="{{ config("app.name") }} Bootstrap 5 Template" class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                                    <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div>
                                                <h3 class="mb-1 fs-4"><a href="javascript:void(0)" class="text-inherit">Senior React
                                                        Developer</a> </h3>
                                                <div>
                                                    <span>at Airtable </span>
                                                    <!-- icon -->
                                                    <span class="text-dark ms-2 fw-medium">5.0 <svg xmlns="http://www.w3.org/2000/svg" width="10"
                            ...
                            <div>
                                <div class="d-md-flex">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <img src="{{ asset("frontend") }}/assets/images/job/job-brand-logo/job-list-logo-3.svg" alt=""
                                        ...
                                        <div class="d-flex justify-content-between mb-4">
                                            <div>
                                                ...
                                                <div>
                                                    <span>at Square </span>
                                                    <!-- icon -->
                                                    <span class="text-dark ms-2 fw-medium">3.9 <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                                                                    height="10" fill="currentColor" class="bi bi-star-fill text-warning align-baseline"
                                                                                                    viewBox="0 0 16 16">
                              <path
                                  d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        ...
                                        <div>
                                            <div class="d-md-flex justify-content-between ">
                                                <div class="mb-2 mb-md-0">
                                                    <!-- year -->
                                                    <span class="me-2"> <i class="fe fe-briefcase text-muted"></i><span class="ms-1 ">2 - 6 years</span></span>
                                                    <!-- year -->
                                                    <span class="me-2">
                            ...
                            <div>
                                <div class="d-md-flex">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <img src="{{ asset("frontend") }}/assets/images/job/job-brand-logo/job-list-logo-4.svg" alt=""
                                             class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                                    <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div>
                                                <!-- heading -->
                                                <h3 class="mb-1 fs-4"><a href="javascript:void(0)" class="text-inherit">Lead Software
                                                        Engineer</a> </h3>
                                                <div>
                                                    <span>at Dot </span>
                                                    <!-- star -->
                        ...
                        <div class="card-body">
                            <div>
                                <div class="d-md-flex">
                                    <div class="mb-3 mb-md-0">
                                        <!-- Img -->
                                        <img src="{{ asset("frontend") }}/assets/images/job/job-brand-logo/job-list-logo-5.svg" alt="" class="icon-shape border rounded-circle">
                                    </div>
                                    <!-- text -->
                                    <div class="ms-md-3  w-100 mt-3 mt-xl-1">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div>
                                                <!-- heading -->
                                                <h3 class="mb-1 fs-4">
                                                    <a href="javascript:void(0)" class="text-inherit">Senior Full Stack Engineer</a>
                                                </h3>
                                                <div>
                                                    <span>at Toggle </span>
                                                    <span class="text-dark ms-2 fw-medium">4.9
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                                             height="10" fill="currentColor" class="bi bi-star-fill text-warning align-baseline"
                                                             viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                                        </svg>
                                                      </span>
                                        ...
                                        <div>
                                            <div class="d-md-flex justify-content-between ">
                                                <div class="mb-2 mb-md-0">
                                                    ...
                                                    <span class="me-2">
                                                        <i class="fe fe-dollar-sign text-muted"></i>
                                                        <span class="ms-1 ">Not discloses</span></span>
                                                    <!-- location -->
                                                    <span class="me-2">
                                                        <i class="fe fe-map-pin text-muted"></i>
                                                        <span class="ms-1 ">Ahmedabad, Gujarat</span></span>
                                                </div>
                                                <div>
                                                    <!-- time -->
