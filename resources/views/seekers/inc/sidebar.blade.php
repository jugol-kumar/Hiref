    ...
    <div class="collapse navbar-collapse" id="sidenav">
        <div class="navbar-nav flex-column">
            ...
            <ul class="list-unstyled ms-n2 mb-0">
                <!-- Nav item -->
                <li class="nav-item {{ Route::is('seeker.editProfile') }}">
                    <a class="nav-link" href="{{ route('seeker.editProfile') }}"><i class="fe fe-settings nav-icon"></i>Edit Profile</a>
                </li>
                <!-- Nav item -->
                <li class="nav-item {{ Route::is('seeker.security') }}">
                    <a class="nav-link " href="{{ route('seeker.security') }}"><i class="fe fe-user nav-icon"></i>Security</a>
                </li>
                <!-- Nav item -->
                <li class="nav-item {{ Route::is('seeker.socialProfile') }}">
                    <a class="nav-link" href="{{ route('seeker.socialProfile') }}"><i class="fe fe-refresh-cw nav-icon"></i>Social
                        Profiles</a>
                </li>
                {{--
                <li class="nav-item">
